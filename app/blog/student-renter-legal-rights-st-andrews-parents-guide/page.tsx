...
export const metadata: Metadata = {
  title: 'Your Child\'s Legal Rights as a Student Renter in St Andrews: What Every Parent Needs to Know | StAndrewsFlats.uk',
  description: 'Parents\' guide to the legal protections covering student renters in St Andrews — HMO licensing, deposits, lease terms, and what to do when things go wrong.',
  alternates: { canonical: 'https://www.standrewsflats.uk/blog/student-renter-legal-rights-st-andrews-parents-guide' },
  openGraph: {
    title: 'Your Child\'s Legal Rights as a Student Renter in St Andrews: What Every Parent Needs to Know',
    description: 'Parents\' guide to the legal protections covering student renters in St Andrews — HMO licensing, deposits, lease terms, and what to do when things go wrong.',
    url: 'https://www.standrewsflats.uk/blog/student-renter-legal-rights-st-andrews-parents-guide',
...
For comprehensive, up-to-date guidance on the St Andrews student lettings market — including property listings, agent reviews, and detailed advice on navigating every stage of the rental process — visit [StAndrewsFlats.uk](https://www.standrewsflats.uk).`
