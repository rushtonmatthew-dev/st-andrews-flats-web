    ...
    <main className="min-h-screen bg-gray-50 px-4 py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8">
          ...
          <section>
            <h2 className="text-[1.375rem] font-bold text-gray-900 mb-3">Why St Andrews is unlike any other UK university town</h2>
          ...
          <section>
            <h2 className="text-[1.375rem] font-bold text-gray-900 mb-3">The timeline you need to know</h2>
            <p className="text-gray-700 leading-7 mb-4">
          ...
          <section>
            <h2 className="text-[1.375rem] font-bold text-gray-900 mb-3">What&apos;s actually available — and what it costs</h2>
          ...
          <section>
            <h2 className="text-[1.375rem] font-bold text-gray-900 mb-3">The regulatory wrinkle: HMO licences</h2>
            <p className="text-gray-700 leading-7 mb-4">
          ...
          <section>
            <h2 className="text-[1.375rem] font-bold text-gray-900 mb-3">The commuter option</h2>
            <p className="text-gray-700 leading-7 mb-4">
          ...
          <section>
            <h2 className="text-[1.375rem] font-bold text-gray-900 mb-3">Five things to do right now</h2>
          ...
          <section>
            <h2 className="text-[1.375rem] font-bold text-gray-900 mb-3">Albany Park and what&apos;s coming</h2>
            <p className="text-gray-700 leading-7 mb-4">
