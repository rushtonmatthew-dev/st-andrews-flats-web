...
export const metadata: Metadata = {
  title: 'How to Find Private Accommodation in St Andrews as a Postgraduate Student | StAndrewsFlats.uk',
  description: 'A practical guide for postgraduate students renting privately in St Andrews — timelines, costs, letting agents, and how to navigate the UK\'s tightest student market.',
  alternates: { canonical: 'https://www.standrewsflats.uk/blog/how-to-find-private-accommodation-st-andrews-postgraduate' },
  openGraph: {
    title: 'How to Find Private Accommodation in St Andrews as a Postgraduate Student',
    description: 'A practical guide for postgraduate students renting privately in St Andrews — timelines, costs, letting agents, and how to navigate the UK\'s tightest student market.',
    url: 'https://www.standrewsflats.uk/blog/how-to-find-private-accommodation-st-andrews-postgraduate',
...
For more guidance on renting privately in St Andrews — including letting agent listings, landlord reviews, and up-to-date property searches — visit [StAndrewsFlats.uk](https://www.standrewsflats.uk).`
