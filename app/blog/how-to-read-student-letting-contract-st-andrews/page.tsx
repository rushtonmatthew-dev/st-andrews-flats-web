/* BLOG_META {"title": "How to Read a Student Letting Contract in St Andrews: What to Check Before You Sign", "audience": "second-year undergraduates", "angle": "practical how-to guide", "date": "2026-04-20"} */
import type { Metadata } from 'next'
import BlogPost from '@/components/BlogPost'

export const metadata: Metadata = {
  title: 'How to Read a Student Letting Contract in St Andrews: What to Check Before You Sign | StAndrewsFlats.uk',
  description: 'Before you sign a St Andrews student flat contract, know exactly what to check. A practical guide to leases, deposits, HMO licences, and tenant rights.',
  alternates: { canonical: 'https://www.standrewsflats.uk/blog/how-to-read-student-letting-contract-st-andrews' },
  openGraph: {
    title: 'How to Read a Student Letting Contract in St Andrews: What to Check Before You Sign',
    description: 'Before you sign a St Andrews student flat contract, know exactly what to check. A practical guide to leases, deposits, HMO licences, and tenant rights.',
    url: 'https://www.standrewsflats.uk/blog/how-to-read-student-letting-contract-st-andrews',
...
const body = `You've fought through the scramble. You joined the group chat, sprinted between viewings, and submitted your application before someone else grabbed the keys. Now a letting agent has emailed you a tenancy agreement and asked you to sign within 48 hours.
...
Finding the right flat in St Andrews is only half the battle. Understanding what you are signing protects you for the full year ahead. For landlord listings, agent information, and the latest guidance on renting in St Andrews, visit [StAndrewsFlats.uk](https://www.standrewsflats.uk).`
