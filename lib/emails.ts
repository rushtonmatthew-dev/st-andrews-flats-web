  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f5f0ea;padding:32px 16px;">
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0"
             style="background:#fffdf9;border-radius:12px;overflow:hidden;
                    box-shadow:0 1px 4px rgba(42,31,24,.1);max-width:100%;">
        <tr>
          <td style="background:#d4622a;padding:24px 32px;">
            <h1 style="margin:0;font-size:20px;font-weight:700;color:#fff;font-family:system-ui,sans-serif;">
              St Andrews Flats
            </h1>
            <p style="margin:4px 0 0;font-size:13px;color:#f5d3c2;">Confirm your email address</p>
          </td>
        </tr>
        <tr>
          <td style="padding:32px;">
            <p style="margin:0 0 16px;font-size:15px;color:#2a1f18;font-family:system-ui,sans-serif;">
              Thanks for signing up! Click the button below to confirm your email address and start receiving alerts.
            </p>
            <a href="${confirmUrl}"
               style="display:inline-block;padding:12px 24px;background:#d4622a;color:#fff;
                      font-size:15px;font-weight:600;border-radius:8px;text-decoration:none;
                      font-family:system-ui,sans-serif;">
              Confirm my email
            </a>
            <p style="margin:24px 0 0;font-size:12px;color:#b8afa6;font-family:system-ui,sans-serif;">
